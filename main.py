...
def start(message: types.Message):
	...
	if message.from_user.username == None:
		bot.send_message(chat_id,'⛔️ Вам необходимо установить логин для работы с ботом!#Слито в @END_RAID')
	else:
		func.first_join(user_id=chat_id, username=username)
		bot.send_message(chat_id,'✅ Добро пожаловать #Слито в @END_RAID, {}!'.format(message.from_user.first_name), reply_markup=kb.menu)
